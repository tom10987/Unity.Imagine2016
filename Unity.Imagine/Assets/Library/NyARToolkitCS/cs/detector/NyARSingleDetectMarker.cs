...
namespace NyAR.Detector {
  ...
  public abstract class NyARSingleDetectMarker {
     ...
     * 矩形情報への参照値。
     */
    public NyARSquare refSquare() { return this._square; }
     ...
     */
    public void setContinueMode(bool i_is_continue) { this._is_continue = i_is_continue; }
  ...
  class NyARSingleDetectMarker_ARTKv2 : NyARSingleDetectMarker {
    ...
    public class ARTKDetector : NyARSquareContourDetector_ARToolKit, NyARSquareContourDetector.CbHandler {
      ...
      public ARTKDetector(NyARSingleDetectMarker i_parent, NyARIntSize i_size) : base(i_size) { this._parent = i_parent; }

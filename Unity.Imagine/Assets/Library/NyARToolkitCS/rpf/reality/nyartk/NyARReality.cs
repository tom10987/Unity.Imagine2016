...
namespace NyAR.Rpf {
  ...
  public class NyARReality {
     ...
     * @throws NyARException 
     */
    public void ChangeTargetToDead(NyARRealityTarget i_item) { ChangeTargetToDead(i_item, 50); }
     ...
     * @return
     */
    public int GetNumberOfUnknown() { return this._number_of_unknown; }

    /**
     * 現在のKnownターゲットの数を返します。
     * @return
     */
    public int GetNumberOfKnown() { return this._number_of_known; }

    /**
     * 現在のDeadターゲットの数を返します。
     * @return
     */
    public int GetNumberOfDead() { return this._number_of_dead; }
     ...
     * @return
     */
    public NyARRealityTargetList RefTargetList() { return this.target; }
     ...
     * @return
     */
    public NyARFrustum refFrustum() { return this._frustum; }

    /**
     * ARToolKitスタイルの射影変換行列を返します。
     * @return
     */
    public NyARPerspectiveProjectionMatrix RefPerspectiveProjectionMatrix() { return this._ref_prjmat; }

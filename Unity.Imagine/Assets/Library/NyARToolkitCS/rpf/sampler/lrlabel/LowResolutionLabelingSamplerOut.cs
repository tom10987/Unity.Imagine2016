...
namespace NyAR.Rpf {
  ...
  public class LowResolutionLabelingSamplerOut {
    ...
    public class Item : NyARManagedObject {
      ...
      public Item(INyARManagedObjectPoolOperater i_pool) : base(i_pool) { }
    }
    ...
    private class AreaPool : NyARManagedObjectPool<Item> {
      public AreaPool(int i_length) { base.initInstance(i_length); return; }
      protected override Item createElement() { return new Item(this._op_interface); }
    }
    ...
    private class AreaStack : NyARPointerStack<Item> {
      public AreaStack(int i_length) : base(i_length) { }
    }
     ...
     * @return
     */
    public Item[] getArray() { return this._stack.getArray(); }

    /**
     * 検出したエリアデータの総数を返します。
     * @return
     */
    public int getLength() { return this._stack.getLength(); }
  }
}

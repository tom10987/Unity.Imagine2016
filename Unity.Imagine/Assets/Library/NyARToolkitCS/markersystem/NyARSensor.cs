...
namespace NyAR.MarkerSystem {
  ...
  public class NyARSensor {
     ...
     * [readonly]
     */
    public INyARPerspectiveCopy GetPerspectiveCopy() { return this._pcopy; }
     ...
     */
    public void UpdateTimeStamp() { this._src_ts++; }

    /**
     * 現在のタイムスタンプを返します。
     * @return
     */
    public long GetTimeStamp() { return this._src_ts; }
     ...
     * @return
     */
    public INyARRgbRaster GetSourceImage() { return this._ref_raster; }
